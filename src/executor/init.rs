...
impl Executor {
    pub fn new() -> Self {
        ...
        let mut executor = Self {
            ...
            // DEPRECATED: Sync with ShellState for compatibility during migration
            arithmetic_expansion_error: Cell::new(false),
            arithmetic_nonfatal_error: Cell::new(false),
            arithmetic_fatal_error: Cell::new(false),
            arithmetic_nounset_error: Cell::new(false),
            ...
            parameter_bad_substitution: Cell::new(false),  // DEPRECATED - sync with ShellState during migration
